...
foreach ($someObject as $key => $value) {
    $sql = "INSERT INTO `ticket`( `bill_no`, `serial`, `count`, `agent`, `scheme`, `amount`, `insertion_date`,`insertion_time`) VALUES ($bill_no,'$value->serial',$value->count,'$agent','$value->scheme',$value->amount,'$date',CONVERT_TZ(NOW(),'-05:30','+00:00'))";
    if (!$con->query($sql)) {
        $result = "1";
        break;
    }
