...
$sql = "INSERT INTO `agents`(`username`, `password`, `role`, `A`, `AB`, `ABC`, `phone`, `name`, `shop`, `address`, `place`,`agent_money_lsk1`,`agent_money_lsk2`,`agent_money_lsk3`,`agent_money_lsk4`,`agent_money_lsk5`,`agent_money_lsk6`,`agent_money_box1`,`agent_money_box2`,`agent_money_ab`,`agent_money_a`,`main_agent`) VALUES ('$username','$password','Sub',$a,$ab,$abc,'$contact','$name','$shop','$address','$place',$agent_money_lsk1,$agent_money_lsk2,$agent_money_lsk3,$agent_money_lsk4,$agent_money_lsk5,$agent_money_lsk6,$agent_money_box1,$agent_money_box2,$agent_money_ab,$agent_money_a,'$agent')";
