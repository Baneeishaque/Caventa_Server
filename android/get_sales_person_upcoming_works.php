...
$status_sql = "SELECT `id`, `name`, `address`, `work_date`, `status`, `sales_person_id` FROM `works` WHERE `sales_person_id`=$sales_person_id AND `work_date` = DATE_FORMAT( CONVERT_TZ( NOW( ) , '-05:30', '+00:00' ),'%Y-%m-%d')";
//echo $status_sql;
